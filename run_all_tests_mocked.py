...
for module in ['requests', 'telegram', 'telegram.ext', 'telegram.error', 'google', 'google.generativeai', 'oci', 'tweepy', 'supabase', 'flask']:
...
from test_security_hardening import TestSecurityHardening
